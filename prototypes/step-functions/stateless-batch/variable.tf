...
variable sns_topic_processor {
  type    = string
  default = "processor-topic"
}

variable sns_topic_processor_deadletter {
  type    = string
  default = "processor-topic-deadletter"
}

variable sns_topic_activator {
  type    = string
  default = "activator-topic"
}

variable sns_topic_activator_deadletter {
  type    = string
  default = "activator-topic-deadletter"
}
